...
class GeoWebAnnotation:
    ...
    def choose_point_mapping_tool(self,interface):
        interface.mapCanvas().setMapTool( PointMapTool(interface) )

    def choose_polygon_mapping_tool(self,interface):
        interface.mapCanvas().setMapTool( PolygonMapTool(interface) )

    def choose_circle_mapping_tool(self,interface):
        interface.mapCanvas().setMapTool( CircleMapTool(interface) )

    def choose_rectangle_mapping_tool(self,interface):
        interface.mapCanvas().setMapTool( RectangleMapTool(interface) )

    def choose_select_mapping_tool(self,interface):
        interface.mapCanvas().setMapTool( SelectMapTool() )
    ...
    def initGui(self):
        ...
        self.add_action(
            ...
            callback=self.choose_polygon_mapping_tool(self.iface),
            parent=self.iface.mainWindow())

        self.add_action(
            icon_path,
            text=self.tr(u'PointMapTool'),
            callback=self.choose_point_mapping_tool(self.iface),
            parent=self.iface.mainWindow())

        self.add_action(
            icon_path,
            text=self.tr(u'SelectMapTool'),
            callback=self.choose_select_mapping_tool(self.iface),
            parent=self.iface.mainWindow())
        
        self.add_action(
            icon_path,
            text=self.tr(u'CircleMapTool'),
            callback=self.choose_circle_mapping_tool(self.iface),
            parent=self.iface.mainWindow())
